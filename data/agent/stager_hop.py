...
import copy, sys, struct, os, hashlib, random, string, hmac, urllib2, socket
import base64
...
try:
    # encode the hop information in a parameter
    hopInfo = base64.b64encode(server + '&index.jsp')
    response = post_message(server + "?" + hopInfo, hmacData)
...
# encode the hop information again
postURI = server + '&index.php'
hopInfo = base64.b64encode(server + '&index.php')
