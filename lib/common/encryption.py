...
import copy, sys, struct, os, hashlib
...
# DH code is directly from: https://github.com/lowazo/pyDHE
#   GPLed

###################################################
#
# The following Diffie Hellman implentation is from
# Mark Loiseau's implementation at:
...
###################################################
#
# The following AES implentation is adapted from 
...
def CBCdec(aesObj, ciphertext, base64=False):
    ...
    lastBlock = aesObj.decrypt(blocks[-1])
    plaintext += strip_PKCS7_padding(lastBlock)
