...
class Listeners:
    ...
    def __init__(self, MainMenu, args=None):
        ...
        # {listenerId : EmPyreServer object}
        self.listeners = {}
    ...
    def is_listener_empyre(self, listenerID):
        """
        Check if this listener name is for Empyre (otherwise for meter).
        """
        cur = self.conn.cursor()
    ...
    def get_stager_config(self, listenerID):
        """
        Returns the (host, stagingKey, pivotServer, hop) information for this listener.
